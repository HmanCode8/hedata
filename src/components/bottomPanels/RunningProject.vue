...
<template>
    <div class="w-full ">
        <div class="flex items-center p-2 w-full border-b">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center">
                    <span class="mx-1">项目列表:</span>
                    <div class="flex items-center">
                ...
                <div class="flex items-center">
                    <el-radio-group v-model="radio1">
                        <el-radio v-for="(item, index) in tips" :value="item.key" :key="index">{{ item.title
                            }}</el-radio>
                    </el-radio-group>
                    <el-icon class="ml-2 text-2xl hover:cursor-pointer hover:scale-110 duration-300" @click="close">
                        <Close />
                    </el-icon>
                </div>
